...
export default function CarbonOperationsPage() {
  return <ScopedIntlProvider namespaces={DASHBOARD_CARBON_OPERATIONS_NAMESPACES}><CarbonOperationsClient /></ScopedIntlProvider>;
}
