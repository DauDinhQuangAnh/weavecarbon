            ...
            <CardContent>
              ...
              {(!company?.address || !company?.tax_id) && (
                <p className="text-xs text-amber-700 mt-3">
                  ...
                  <Link href={appRoutes.toAppPath("/settings")} className="underline text-primary">Cài đặt</Link>{' '}
          ...
          <Card>
            <CardHeader>
              <div className="flex items-center justify-between gap-2">
                ...
                <Link href={appRoutes.toAppPath("/evidence")} className="shrink-0">
                    ...
                    <TableRow key={e.id}>
                      ...
                      <TableCell>
                        {e.evidence_document_id ? (
                          <Link href={appRoutes.toAppPath(`/evidence?highlight=${e.evidence_document_id}`)} className="text-primary text-xs inline-flex items-center gap-1">
                    ...
                    <TableRow key={f.id}>
                      ...
                      <TableCell>
                        {f.evidence_document_id ? (
                          <Link href={appRoutes.toAppPath(`/evidence?highlight=${f.evidence_document_id}`)} className="text-primary text-xs inline-flex items-center gap-1">
          ...
          <Card>
            ...
            <CardContent>
              ...
              <p className="text-xs text-muted-foreground mt-3">
                <Link href={appRoutes.toAppPath("/evidence")} className="text-primary underline">Tải chứng từ nhật ký sản xuất</Link>{' '}
                  ...
                  {products.length === 0 && (
                    <TableRow>
                      <TableCell colSpan={6} className="text-center text-muted-foreground text-sm">
                        Chưa có sản phẩm.{' '}
                        <Link href={appRoutes.toAppPath("/products")} className="text-primary underline">Tạo sản phẩm</Link>
                      </TableCell>
                    </TableRow>
                  )}
                  {products.slice(0, 20).map((p) => (
                    <TableRow key={p.id}>
                      <TableCell className="text-xs">
                        <Link href={appRoutes.toAppPath("/products")} className="text-primary inline-flex items-center gap-1">
            ...
            <CardContent>
                ...
                <TableBody>
                  ...
                  {productSummary.slice(0, 30).map((p) => (
                    <TableRow key={p.id}>
                      ...
                      <TableCell>
                        <Button size="sm" variant="ghost" className="h-7 text-xs p-1" onClick={() => router.push(appRoutes.toAppPath('/products'))}>
                          {p.hasCalc
              ...
              {productSummary.some((p) => !p.hasCalc) && (
                <p className="text-xs text-amber-700 mt-3">
                  ...
                  <Link href={appRoutes.toAppPath("/carbon-calculator")} className="underline text-primary">Carbon Calculator</Link>{' '}
              ...
              {productSummary.some((p) => p.embeddedPerTonne == null) && (
                <p className="text-xs text-red-600 mt-2">
                  ...
                  <Link href={appRoutes.toAppPath("/products")} className="underline text-primary">trang Sản phẩm</Link>{' '}
