  ...
  return (
    <div className="space-y-6">
      ...
      <Dialog
        ...
        {detailShipment &&
        <DialogContent className="h-dvh w-screen max-w-[100vw] overflow-hidden rounded-none p-0 [&>button]:right-3 [&>button]:top-3 md:h-[min(92dvh,56rem)] md:w-[min(96vw,68rem)] md:max-w-none md:rounded-xl">
